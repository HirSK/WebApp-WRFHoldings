...
(1, 'K.Perera', 'HW0967', 'Dalupotha', 1, '2017-08-20', 'C.kulathunga'),
(56, 'K.Perera', 'HW0967', 'Negombo', 1, '0000-00-00', 'C.kulathunga');
...
(111, 'DSP00498', 2000, 2000, '2017-12-06 12:12:58', '');
...
INSERT INTO `invoice` (`idInvoice`, `InvoiceValue`, `InvoiceNetValue`, `Customer_idCustomer`, `cash`, `cheque`, `credit`, `SalesRtn`, `Variance`, `Discount`, `MKTrtn`, `Remarks`, `Collection_idCollection`, `invoice_complete_date`) VALUES
(100, 5000, 5000, 'DSU02792', 1000, 2000, 1000, 0, 1000, 0, 0, '', 1, '2017-12-04 09:29:01'),
(111, 6000, 6000, 'DSP00498', 4000, 0, 2000, 0, 0, 0, 0, '', 56, '2017-12-06 12:12:58'),
...
--
ALTER TABLE `collection`
  MODIFY `idCollection` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `credit`
  ADD CONSTRAINT `fk_credit_invoice` FOREIGN KEY (`invoice_credit_id`) REFERENCES `invoice` (`idInvoice`);
