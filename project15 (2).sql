...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2017 at 08:56 AM
...
CREATE TABLE `allowance` (
  ...
  `AllowanceName` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `cheque` (
  ...
  `ChequeNumber` varchar(200) CHARACTER SET latin1 NOT NULL,
  `ChequeBankName` varchar(200) CHARACTER SET latin1 NOT NULL,
  `ChequeBankBranch` varchar(200) CHARACTER SET latin1 NOT NULL,
  `ChequeBKdate` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `collection` (
  ...
  `CollectionDriver` varchar(45) CHARACTER SET latin1 NOT NULL,
  `CollectionVehicle` varchar(45) CHARACTER SET latin1 NOT NULL,
  `CollectionArea` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `collectionreport` (
  ...
  `CollectionReportDate` varchar(45) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `customer` (
  ...
  `CustomerAddress` varchar(300) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `customer` (`idCustomer`, `CustomerName`, `CustomerAddress`) VALUES
(1, 'SPECIAL EVENTS', '');
...
CREATE TABLE `deduction` (
  ...
  `DeductionType` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `delivery_vehicle` (
  ...
  `Delivery_VehiclePlateNumber` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
  `Outlet_idOutlet` int(11) NOT NULL,
...
CREATE TABLE `employee` (
  ...
  `EmployeeFullName` varchar(145) CHARACTER SET latin1 NOT NULL,
  `EmployeeNameWithInitials` varchar(100) CHARACTER SET latin1 NOT NULL,
  `EmployeeNIC` varchar(45) CHARACTER SET latin1 NOT NULL,
  `EmployeeBirthdate` varchar(45) CHARACTER SET latin1 NOT NULL,
  `EmployeePosition` varchar(45) CHARACTER SET latin1 NOT NULL,
  `EmployeeJoinedDate` varchar(45) CHARACTER SET latin1 NOT NULL,
  `EmployeeContactNumber` varchar(45) CHARACTER SET latin1 NOT NULL,
  `EmployeeAddress` varchar(245) CHARACTER SET latin1 DEFAULT NULL,
  `EmployeeEmail` varchar(145) CHARACTER SET latin1 DEFAULT NULL,
  `Outlet_idOutlet` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `outlet` (
  ...
  `Outletname` varchar(45) CHARACTER SET latin1 NOT NULL,
  `OutletLocation` varchar(200) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `petty_cash` (
  ...
  `Petty_CashType` varchar(45) CHARACTER SET latin1 NOT NULL,
  `Petty_CashDescription` varchar(45) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `user` (
  ...
  `UserDescription` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
