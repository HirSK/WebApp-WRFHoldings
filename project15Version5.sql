...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2017 at 07:09 AM
...
CREATE TABLE `attendance` (
  ...
  `FullDayHalfDay` bit(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `calendar` (
  ...
  `Working/Holiday` bit(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `employee` (
  ...
  `Salary_ETF_Amount` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `employee` (`idEmployee`, `EmployeeFullName`, `EmployeeNameWithInitials`, `EmployeeNIC`, `EmployeeBirthdate`, `EmployeePosition`, `EmployeeJoinedDate`, `EmployeeContactNumber`, `EmployeeAddress`, `EmployeeEmail`, `Outlet_idOutlet`, `SalaryBasic`, `Salary_ETF_Amount`) VALUES
(2, 'Kamal Perera', 'K.Perera', '821467209V', '10/03/1982', 'Delivery driver', '04/08/2016', '0715678345', '70/3,Namal mawatha,Gampaha', 'kamalperera@gmail.com', 1, 0, 0),
(4, 'Hirunika Sumuduni karunathilaka', 'H.S.Karunathilaka', '917657984V', '03/12/1991', 'Collection officer', '09/08/2017', '0774567398', '34/2,Kalyani street,Gampaha', 'hiru@gmail.com', 2, 0, 0),
(5, 'Admin', 'Admin', '856782967V', '11/05/1985', 'CEO', '14/08/2017', '0778467987', '12,abc,asd', 'asd@qwe.lk', 5, 0, 0),
(6, 'Chanaka Kulathunga', 'C.kulathunga', '807342820V', '07/11/1980', 'Collection officer', '23/05/2015', '0775679431', 'Smagai mawatha,Negombo', 'chanakak@gmail.com', 1, 0, 0),
(7, 'Kasun Krishantha', 'K.Krishantha', '94250114V', '06/09/1994', 'Outlet Supervisor', '21/08/2017', '0725674563', 'Batapola,Ambalangoda', 'kasun@gmail.com', 1, 0, 0),
(9, 'Dilmi Shanika', 'D.Shanika', '807965213V', '5/12/1980', 'Outlet Supervisor', '05/05/2017', '0715498264', '12,qwer,asd-06', 'sasa@ksjk.lk', 4, 0, 0);
...
INSERT INTO `user` (`idUser`, `Username`, `UserPassword`, `Employee_idEmployee`, `createdBy`, `createdDtm`, `roleName`) VALUES
(3, 'S/01/07', '3daa2c246564baf6d1909404d0c52ca53c9e7917', 7, 5, '2017-10-28', 'Outlet Supervisor'),
(4, 'S/04/09', '5738afb080edbb735fc0b7521fdd1ab73eaaf572', 9, 5, '2017-12-04', 'Outlet Supervisor'),
(5, 'S/05/05', 'f54ff9355c7e4573353657e8a7b077e386a500a9', 5, 5, '2017-12-04', 'Admin');
...
ALTER TABLE `attendance`
  ...
  ADD KEY `fk_Employee_has_Company_Work_Period_Company_Work_Period1_idx` (`DateOfDay`,`FullDayHalfDay`),
  ADD KEY `fk_Employee_has_Company_Work_Period_Employee1_idx` (`Employee_idEmployee`,`AttendanceID`);

--
-- Indexes for table `calendar`
--
ALTER TABLE `calendar`
  ADD PRIMARY KEY (`CalenderId`,`CalenderDate`);
...
ALTER TABLE `salary_month`
  ADD PRIMARY KEY (`idSalaryMonth`),
  ADD KEY `fk_Salary_Employee1_idx` (`Employee_idEmployee`),
  ADD KEY `fk_Salary_Company_Work_Period1_idx` (`SalaryMonth`,`DaysWorked`);
...
ALTER TABLE `user`
  ...
  ADD KEY `fk_User_Employee1_idx` (`Employee_idEmployee`);
...
--
ALTER TABLE `outlet`
  MODIFY `idOutlet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `salary_month`
  MODIFY `idSalaryMonth` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `fk_Employee_has_Company_Work_Period_Employee1` FOREIGN KEY (`Employee_idEmployee`) REFERENCES `employee` (`idEmployee`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `salary_has_allowance`
  ADD CONSTRAINT `salary_has_allowance_ibfk_1` FOREIGN KEY (`Salary_idSalary`) REFERENCES `salary_month` (`idSalaryMonth`),
  ADD CONSTRAINT `salary_has_allowance_ibfk_2` FOREIGN KEY (`Allowance_idAllowance`) REFERENCES `allowance` (`idAllowance`);

--
-- Constraints for table `salary_month`
--
ALTER TABLE `salary_month`
  ADD CONSTRAINT `fk_Salary_Employee1` FOREIGN KEY (`Employee_idEmployee`) REFERENCES `employee` (`idEmployee`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_User_Employee1` FOREIGN KEY (`Employee_idEmployee`) REFERENCES `employee` (`idEmployee`) ON DELETE NO ACTION ON UPDATE NO ACTION;
