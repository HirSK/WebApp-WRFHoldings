...
$table1 .='<tr>
             ...
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Invoice Number</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Cash</th>
...
$table1 .='<tr>
            ...
            <td style="border:1px solid #000;">'.$row['Customer_idCustomer'].'</td>
            <td style="border:1px solid #000;">'.$row['idInvoice'].'</td>
            <td style="border:1px solid #000;">'.$row['cash'].'</td>
...
$table2.='<tr>
             ...
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Customer Code</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Invoice Number</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Return Credit</th>
...
foreach ($collection2 as $row) {
  ...
  if(((int)$row['total_credit']-(int)$row['credit_topay']) != '0'){
$table2 .='<tr>
            <td style="border:1px solid #000;">'.$no++.'</td>
            <td style="border:1px solid #000;">'.$row['invoice_credit_id'].'</td>
            <td style="border:1px solid #000;">'.$row['customer_id'].'</td>
            <td style="border:1px solid #000;">'.((int)$row['total_credit']-(int)$row['credit_topay']).'</td>
