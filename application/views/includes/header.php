                    ...
                    <ul class="treeview-menu">
                     ...
                     <?php
                       ...
                       if($loggerRole == ROLE_SUPERVISOR || $loggerRole == ROLE_ADMIN)
                        ...
                        <li><a href="<?php echo base_url()?>index.php/AttendanceController">View Attendance Summary</a></li>
                        <li><a href="<?php echo base_url()?>index.php/CalendarController/viewEmployeeAttendance">Employee Attendance </a></li>
