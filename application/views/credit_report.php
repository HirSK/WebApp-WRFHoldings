...
$table1 .='<tr>
             ...
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Customer ID</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Total Credit</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Credit topay</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Credit Start Date</th>
             <th bgcolor="#B2BEB5" style="border:1px solid #000;">Last Credit Taken Date</th>
...
$table1 .='<tr>
            ...
            <td style="border:1px solid #000;">'.$row['credit_start_date'].'</td>
            <td style="border:1px solid #000;">'.$row['credit_lasttaken_date'].'</td>
            <td style="border:1px solid #000;">'.$row['outletID'].'</td>
