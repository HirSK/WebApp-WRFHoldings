                         ...
                         <form method="post" action="<?php echo base_url()?>index.php/CustomerController/updateCustomer">
                          ...
                          <div class="row">
                            <div class="form-group">
                              <label for="CustID" class="col-sm-6 control-label">Customer ID</label>
                              <div class="col-sm-7">
                                <input type="text" class="form-control" id="CustID" name="CustomID" required readonly>
                              </div>
                            </div>
                ...
                <div class="box box-primary" style="padding-top: 0px">
                    ...
                    <?php
                        ...
                        foreach ($customerRecord as $row){
                            ...
                            ?><tr>
                            <td><input name="checkbox[]" class="case" type="checkbox" value=<?php echo $row->idCustomer;?>></td> 
