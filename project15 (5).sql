...
(1, 'DSP00498', 'SPECIAL EVENTS', '', NULL, NULL);
...
INSERT INTO `supervisor` (`Employee_idEmployee`, `Employee_Outlet_idOutlet`, `User_idUser`) VALUES
(5, 1, 1);
...
--
ALTER TABLE `delivery_vehicle`
  MODIFY `idDelivery_Vehicle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
