...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2017 at 05:20 AM
...
INSERT INTO `invoice` (`idInvoice`, `InvoiceValue`, `InvoiceNetValue`, `Customer_idCustomer`, `cash`, `cheque`, `credit`, `SalesRtn`, `Variance`, `Discount`, `MKTrtn`, `Remarks`, `Collection_idCollection`, `Collection_Outlet_idOutlet`, `invoice_order_date`, `invoice_complete_date`) VALUES
(234, 3000, 3000, 'DSP00498', 500, 0, 0, 0, 2500, 0, 0, '', 1, 1, '12/12/2017', '2017-12-04 04:52:50');
