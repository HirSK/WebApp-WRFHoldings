...
INSERT INTO `attendance` (`AttendanceID`, `Employee_idEmployee`, `DateOfDay`, `CheckIn`, `CheckOut`, `FullDayHalfDay`) VALUES
(1, 6, '2017-12-13', b'1', b'1', b'1'),
(2, 6, '2017-12-14', b'1', b'1', b'1'),
(3, 6, '2017-12-15', b'1', b'0', b'0'),
(4, 6, '2017-12-17', b'1', b'0', b'0'),
(5, 7, '2017-12-12', b'1', b'1', b'1');
...
CREATE TABLE `calendar` (
  ...
  `Working_Holiday` bit(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `calendar` (`outletID`, `CalendarDate`, `Working_Holiday`) VALUES
(1, '2017-12-01', b'1'),
(1, '2017-12-04', b'0'),
(1, '2017-12-13', b'1'),
(1, '2017-12-15', b'1'),
...
(5, 'K.Perera', 'HW0967', 'Dalupotha', 1, '2017-12-13', 'C.kulathunga'),
(6, 'K.Perera', 'HW0967', 'Gampaha', 1, '2017-12-14', 'C.kulathunga');
...
(111, 'DSP00498', 2000, 2000, '2017-12-07 03:38:13', '');
...
CREATE TABLE `employee` (
  ...
  `Salary_ETF_Amount` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5, 'Weerasuriyage Vimal Kalana', 'W.V.Kalana', '856782967V', '11/05/1985', 'Outlet Supervisor', '14/08/2017', '0778467987', '30/4,Kingway road,Malabe', 'vimalkalana@gmail.com', 1, 0, 0),
...
(9, 'Dilmi Shanika', 'D.Shanika', '807965213V', '5/12/1980', 'Outlet Supervisor', '05/05/2017', '0715498264', '', '', 4, 0, 0);
...
(111, 6000, 6000, 'DSP00498', 4000, 0, 2000, 0, 0, 0, 0, '', 5, '', '2017-12-07 03:38:13');
...
ALTER TABLE `calendar`
  ADD PRIMARY KEY (`outletID`,`CalendarDate`),
...
--
ALTER TABLE `collection`
  MODIFY `idCollection` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
